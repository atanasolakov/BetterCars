...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getBrand = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/brands', config: {
          headers: {
    ...
    const getVehicals = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/all_vehicles', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
    ...
    const getExtras = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/extras', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
    ...
    const getcategoryOptions = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/categories', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
    ...
    const getGearBoxes = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/gearboxes', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
    ...
    const getEngines = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/engines', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
    ...
    const getRegions = async () => {
      await axios({method: 'get', url: 'http://192.168.1.6:8080/vehicle/regions', config: {
          headers: {
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
            "Access-Control-Allow-Headers": "Origin, Content-Type, X-Auth-Token"
